...
let handleWindowResize = () => {
    let sidenav = store.state.sidebarToggle.sidebarToggleProperties.isSideNavOpen

    // if (window.innerWidth <= 1200) {
    //     if (store.state.sidebarToggle.sidebarToggleProperties.isSideNavOpen) {
    //         store.commit('sidebarToggle/toggleSidebarProperties')
    //     }
    // } else {
    //     if (!store.state.sidebarToggle.sidebarToggleProperties.isSideNavOpen) {
    //         store.commit('sidebarToggle/toggleSidebarProperties')
...
<template>
    <div class="side-content-wrap">
        <div class="side-content-wrap">
            <div
                :class="
                    store.state.sidebarToggle.sidebarToggleProperties
                        .isSideNavOpen === true
                        ? 'open'
                        : ''
                "
            ...
            >
                <perfect-scrollbar>
                    <ul class="navigation-left bg-gray-100 dark:bg-gray-800">
                        <!-- <div 
                        ...
                        >
                            <div class="nav-item-hold">
                                <i class="i-Split-Vertical text-3xl"></i>
                                <p>Leads</p>
                            </div>
                        </router-link>
                        <router-link
